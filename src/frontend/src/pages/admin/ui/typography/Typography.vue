      ...
      <va-card class="col-span-12">
        ...
        <va-card-content>
          <div class="mb-8">
            ...
            <p>
              Of all of the celestial bodies that capture our attention and fascination as astronomers, none has a greater influence on life on planet
              Earth than it’s own satellite, the moon. When you think about it.
            </p>
          </div>
          <div class="mb-8">
            <h2>Display 2 Heading</h2>
            <p>None has a greater influence on life on planet Earth than it’s own satellite, the moon. When you think about it.</p>
          </div>
          <div class="mb-8">
            <h3>Display 3 Heading</h3>
            <p>
              Let’s talk about meat fondue recipes and what you need to know first. Meat fondue also known as oil fondue is a method of cooking all
              kinds of meats, poultry, and seafood in a pot of heated oil.
            </p>
          </div>
          <div class="mb-8">
            ...
            <p>
              ...
              great things we have discovered about life.
            </p>
          </div>
          <div class="mb-8">
            <h5>Display 5 Heading</h5>
            <p>
              There is a moment in the life of any aspiring astronomer that it is time to buy that first telescope. It’s exciting to think about
...
&lt;/p></pre
            ...
            <p>
              ...
              <span class="text--code">currentColor</span> none has a greater influence on life on planet Earth than it’s own satellite, the moon.
            </p>
          </div>
        </va-card-content>
      </va-card>
        ...
        <va-card-content>
          ...
          <div class="mb-8">
            <blockquote class="va-blockquote" :style="{ borderColor: colors.primary }">
              <p>
                BQ: Let’s talk about meat fondue recipes and what you need to know first. Meat fondue also known as oil fondue is a method of cooking
                all kinds.
              </p>
              <p>
                <i>— Mister Lebowski</i>
          ...
          <div class="mb-8">
            <div class="text-block">
              ...
              <span
                >Of all of the celestial bodies that capture our attention and fascination as astronomers, none has a greater influence on life on
                planet Earth than it’s own satellite, the moon. When you think about it.</span
              >
            </div>
          </div>
          <div class="mb-8">
